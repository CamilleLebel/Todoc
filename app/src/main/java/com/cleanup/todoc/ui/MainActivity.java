...
public class MainActivity extends AppCompatActivity implements TasksAdapter.DeleteTaskListener {
    ...
    private void initProjects() {
        viewModel.getAllProjects().observe(this, pProjects ->
    ...
    private void populateDialogSpinner() {
        final ArrayAdapter<Project> projectsAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, allProjects);
